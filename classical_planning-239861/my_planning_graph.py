    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        for effectA in actionA.effects:
            for effectB in actionB.effects:
                ...
                #if (str(effectA) == ''.join(['~', str(effectB)])) or (''.join(['~', str(effectA)]) == str(effectB)):
                    return True
        return False
    ...
    def _interference(self, actionA, actionB):
        ...
        for effectA in actionA.effects:
            for precondB in actionB.preconditions:
                ...
                #if (str(effectA) == ''.join(['~', str(precondB)])) or (''.join(['~', str(effectA)]) == str(precondB)):
                    return True
        for precondA in actionA.preconditions:
            for effectB in actionB.effects:
                if precondA == ~effectB or ~precondA == effectB:
                #if (str(precondA) == ''.join(['~', str(effectB)])) or (''.join(['~', str(precondA)]) == str(effectB)):
                    return True
        return False
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        for mutA in self.parents[literalA]:
            for mutB in self.parents[literalB]:
                if not self.parent_layer.is_mutex(mutA, mutB):
                    return False
        return True
    ...
    def _negation(self, literalA, literalB):
        ...
        ##return literalA.args == literalB.args and literalA.op != literalB.op
        ##return (''.join(['~', str(literalA)]) == str(literalB)) or (str(literalA) == ''.join(['~', str(literalB)])) or (''.join(['-', str(literalA)]) == str(literalB)) or (str(literalA) == ''.join(['-', str(literalB)]))
...
class PlanningGraph:
    ...
    def h_levelsum(self):
        ...
        for goal in self.goal:
            if self.h_levelcost(goal) != None:
                level_sum.append(self.h_levelcost(goal))
    ...
    def h_maxlevel(self):
        ...
        level_list = []
        for goal in self.goal:
            level_list.append(self.h_levelcost(goal))
